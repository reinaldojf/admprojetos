...
public class DiretorTeste {
	...
	public static void main(String[] args) {
		...
		System.out.println("O diretor "+d1.getNome()+" tem salário final:"+d1.calcularSalarioFinal());
		...
		System.out.println("O diretor "+d2.getNome()+" tem salário final:"+d2.calcularSalarioFinal());
	}
