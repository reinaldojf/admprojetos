...
import br.edu.infnet.model.dominio.Analista;
...
public class AnalistaTeste {
	...
	public static void main(String[] args) {
		...
		System.out.println("O analista "+a1.getNome()+" tem salário final:"+a1.calcularSalarioFinal());
		...
		System.out.println("O analista "+a2.getNome()+" tem salário final:"+a2.calcularSalarioFinal());
}
