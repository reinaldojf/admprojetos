...
import br.edu.infnet.model.dominio.Projeto;
import br.edu.infnet.model.dominio.Empregado;
import br.edu.infnet.model.dominio.Analista;
import br.edu.infnet.model.dominio.Cliente;

public class ProjetoTeste {

	public static void main(String[] args) {
		Projeto projeto = new Projeto();
		projeto.setCodigo("0001");
